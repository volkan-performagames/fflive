...
const App = () => {
  return (
    <div id="container">
      <div
        className="top-nav-desktop show-for-large sticky hide-for-print"
        id="top-menu-desktop"
      >
        <a href="#" className="site-logo-desktop">
          <img
            src="./static/svg/header-logo-desktop-sticky-fm21.svg"
            className="site-logo-desktop__image-sticky"
            alt="Home"
            width="57.236"
            height={26}
          />
          <img
            src="./static/svg/header-logo-desktop-large-fm21.svg"
            className="site-logo-desktop__image"
            alt="Home"
            width="179.737"
            height={50}
          />
        </a>
        <div className="top-nav-desktop__cta-wrapper">
          <a className="top-nav-desktop__cta"> ŞİMDİ OYNA </a>
        </div>
      </div>
      <div className="main-content">
        <div className="game-banner-2022 fm22-mobile">
          ...
          <div className="row hide-for-large game-banner-2022__title-wrapper">
            <div className="columns">
              ...
              >
                <img
                  src="./static/svg/fm22-mobile-white.svg"
            ...
            >
              ...
              >
                <p>
                  ...
                  sürümünde daha önce hiç olmadığı kadar fazla ülkede izini
                  bırak.
                </p>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="./static/svg/ios-app-store-tr.svg"
                    alt="App Store"
                  />
                </a>
                <a
                ...
                >
                  <img
                    src="./static/svg/google-play-tr.svg"
                    alt="Google Play"
                  />
                </a>
              </div>
            ...
            <div className="row">
              <div className="columns small-centered large-9 c-features-2022__content">
                ...
                <div className="c-features-2022__abstract">
                  <p>
                    Detaydan ödün vermeden basitlik. Futbol menajerlik
                    ihtiyacını hemen gidermen için.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="columns medium-4 c-feature-box-2022">
                ...
                <div className="c-feature-box-2022__copy">
                  <p>
                    ...
                    taktiksel şablonlar hemen oyuna başlayıp hızla tarzını
                    ortaya koymanı sağlıyor. Takımını ligin zirvesine uçuracak
                    taktikleri bir araya getirerek farkını göster.
                  </p>
                </div>
              </div>
              <div className="columns medium-4 c-feature-box-2022">
                ...
                <div className="c-feature-box-2022__copy">
                  <p>
                    Maç günü şöleninin tadını çıkart ve yukarıdan gözüken
                    dijital yedek kulübesinde yerini al. Takımın o çok değerli
                    üç puanı garantilemek için çabalarken aksiyonu takip et ve
                    planlarının gerçekleşmesine şahit ol.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="video-2022">
          ...
          <div className="video-2022__content-wrapper">
            <div className="video-2022__content">
              <button
                className="button-fm22 button-fm22--skewed video-2022__play-btn"
          ...
          <div className="row gp-image-text-2022__row">
            ...
            <div className="columns large-6 gp-image-text-2022__content-wrapper">
              ...
              >
                ...
                <p>
                  Gözlemleme ve transferlere yapılan köklü değişiklikler
                  oyundaki en büyük yetenekleri bulup ekibine katmayı hiç
              ...
              >
                <a href="#" className="button-fm22 button-fm22--skewed">
        ...
        <div className="req-grid-2022__wrapper element">
          <div className="row">
            <div className="columns req-grid-2022">
              <h2 className="req-grid-2022__title formatted-title">
                UYUMLULUK
              </h2>
              <ul
        ...
        <div className="lp-fmfc-2022">
          <img
            src="./static/svg/bg-sm(2).svg"
            className="lp-fmfc-2022__bg hide-for-medium"
            alt=""
            width={805}
            height={522}
          />
          <img
            ...
            className="lp-fmfc-2022__bg show-for-medium hide-for-large"
            alt=""
            width={798}
            height={281}
          />
          <img
            ...
            className="lp-fmfc-2022__bg show-for-large"
            alt=""
            width={1513}
            height={794}
          />
          <picture>
            {/* <source
        srcset="
          /themes/custom/fmtwentytwentythree/img/components/lp-fmfc-2022/image-sm@2x.webp
        "
      ...
      <source
        srcset="
          /themes/custom/fmtwentytwentythree/img/components/lp-fmfc-2022/image-sm@2x.jpg
        "
        media="(max-width: 639px)"
        width="1513"
        height="794"
      ...
      <source
        srcset="
          /themes/custom/fmtwentytwentythree/img/components/lp-fmfc-2022/image-md@2x.webp
        "
      ...
      <source
        srcset="
          /themes/custom/fmtwentytwentythree/img/components/lp-fmfc-2022/image-md@2x.jpg
        "
      ...
      <source
        srcset="./static/img/fflive-img-006.jpg"
        width="957"
        height="664"
      ...
      /> */}
          ...
          <img
            ...
            alt=""
            className="lp-fmfc-2022__frills hide-for-medium"
            width="393.48"
            height={121}
          />
          <img
            ...
            alt=""
            className="lp-fmfc-2022__frills show-for-medium hide-for-large"
            width={768}
            height={100}
          />
          <img
            ...
            alt=""
            className="lp-fmfc-2022__frills show-for-large"
            width="326.648"
            height={794}
          />
          <div className="row lp-fmfc-2022__row">
            <div className="columns small-centered large-uncentered lp-fmfc-2022__content-wrapper">
              <picture>
                <source
                  srcSet="./static/img/fflive-img-000.png"
                  width={632}
                  height={186}
                  type="image/webp"
                />
                <img
                  src="./static/img/fflive-img-000.png"
                  width={632}
                  height={186}
                  className="lp-fmfc-2022__logo"
                />
              </picture>
              <div className="large-7">
                <h2 className="lp-fmfc-2022__title formatted-title">
                  TAKIMA KATILIN <br />
                  <i>ÖDÜL KAZANIN</i>
                </h2>
              </div>
              <div className="large-6">
                <div className="copy lp-fmfc-2022__copy">
                  <p>
                    FMFC'ye kayıt olun ve özellik duyurularına ve oyun
                    bilgilerine herkesten önce erişin, oyun tercihlerinize göre
                    uyarlanan içeriği ve üyelere özel ödül ve teşvikleri alın.
                  </p>
                </div>
                <div className="lp-fmfc-2022__buttons">
                  <a
                    href="#"
                    className="button-fm22 button-fm22--skewed lp-fmfc-2022__button"
                  >
                    <span>FMFC'YE KAYDOL</span>
                  </a>
                </div>
                <div className="lp-fmfc-2022__bottom-text">
                  <p>
                    Zaten üye misiniz?
        ...
        <a href="#" className="sticky-fmfc-bar">
          <div className="sticky-fmfc-bar__content">
            <p className="sticky-fmfc-bar__label" id="sticky_bar">
              <img src="./static/svg/fmfc-logo-white.svg" />
              Kadrosuna Katılın
            </p>
          </div>
        </a>
